...
В negative тестах нужно найти ситуацию, когда API возвращает код 404 и пустой массив данных и написать тесты для этого случая
...
В negative тестах нужно убедиться, что при передаче в запросе невалидных значений полей “userId", “id”, “title” и “completed” - API
возвращает код 200 и пустой массив данных и написать тесты для этого случая

Все тесты должны успешно проходить


2. Тестирование json sсhema сервиса jsonplaceholder.typicode.com
...
Для теста Listing all resources нужно использовать файл со схемой из теста Getting a resource
указав ссылку на него в схеме
...
Все тесты должны успешно проходить
Критерии оценки: Репозиторий должен быть правильно оформлен: README, gitignore
(никаких служебных или лишних файлов), requirements.txt, PEP8